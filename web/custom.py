            ...
            if self._token_expired(user.access_token):
                ...
                try:
                    ...
                    if refreshed:
                        ...
                        # Refresh returned None - let Airflow handle re-auth
                        log.warning("Token refresh returned None, re-authentication needed")
                        return False
                    ...
                    if "invalid_grant" in error_str or "Token is not active" in error_str:
                        ...
                        # Simply return False - Airflow will trigger OAuth flow
                        return False
                    else:
